...
def funcao_secundaria():
    ...
    if nome == '' and dat1dia == '' and dat1mes == '' and dat1ano == '' and debitoreal == '' and debitocentavos == '':
        ...
        arquivo = open("C:\\Users\\Admin\\Desktop\\Programação\\VS Code\\4. Python\\QTprojetos\\Sistema de Cadastro de Clientes\\duastelasteste.txt", "a")

        arquivo.write('NOME:' + nome + '  ' + 'DATA: ' + dat1dia +'/'+ dat1mes +'/'+ dat1ano + '  ' + '\n\n')
        arquivo.close()
        
        #Abrindo e salvando um segundo arquivo
        arquivo2 = open("C:\\Users\\Admin\\Desktop\\Programação\\VS Code\\4. Python\\QTprojetos\\Sistema de Cadastro de Clientes\\duastelasteste2.txt", "a")
...
def funcao_secundaria2():
    ...
    if pnome == '':
        ...
        arquivo = open("C:\\Users\\Admin\\Desktop\\Programação\\VS Code\\4. Python\\QTprojetos\\Sistema de Cadastro de Clientes\\duastelasteste.txt", "r")
        contador = 0
        for linha in arquivo:
            ...
            if pnome in linha:
                ...
                tela3.frame_2.show()
                arquivo2 = open("C:\\Users\\Admin\\Desktop\\Programação\\VS Code\\4. Python\\QTprojetos\\Sistema de Cadastro de Clientes\\duastelasteste2.txt", "r")
                contador = 0
...
def funcao_concluir_edicao():
    ...
    if novnome == '' and novvalorreal == '' and novvalorcentavos == '' and datadia == '' and datames == '' and dataano == '':
        ...
        editarquivo = open('C:\\Users\\Admin\\Desktop\\Programação\\VS Code\\4. Python\\QTprojetos\\Sistema de Cadastro de Clientes\\duastelasteste2.txt', 'r')
...
def funcao_concluir_edicao2():
    ...
    if novnome == '' and novvalorreal == '' and novvalorcentavos == '' and datadia == '' and datames == '' and dataano == '':
        ...
        editarquivo = open('C:\\Users\\Admin\\Desktop\\Programação\\VS Code\\4. Python\\QTprojetos\\Sistema de Cadastro de Clientes\\duastelasteste.txt', 'r')
...
def funcao_excluir2():
    ...
    if confirmenome == '':
        ...
        print('Acerto!')
        excluirarquivo = open('C:\\Users\\Admin\\Desktop\\Programação\\VS Code\\4. Python\\QTprojetos\\Sistema de Cadastro de Clientes\\duastelasteste2.txt', 'r')
...
def funcao_excluir3():
    ...
    if confirmenome == '':
        ...
        excluirarquivo = open('C:\\Users\\Admin\\Desktop\\Programação\\VS Code\\4. Python\\QTprojetos\\Sistema de Cadastro de Clientes\\duastelasteste.txt', 'r')
